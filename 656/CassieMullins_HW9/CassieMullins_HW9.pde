...
* 
* Program now supports DRT
* Camera Lens Size and number of samples can be defined to create out of focus effect
* Some shapes can now be translated to create animations and motionblur can be added to the animation
* Imperfect reflection and refraction can be added to reflective and refractive materials to create glossy and transclucent materials
*/
